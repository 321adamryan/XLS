'AdamRyan
'Filename=SplitByColumn
'Description=Loops through a specified column, and split each distinct values into a separate file by making a copy and deleting rows below and above
'Filetype=bas
'License=OpenSource

Attribute VB_Name = "SplitDate"
